...
- Latest pacing decision: part 1 takes 6.5 seconds and part 2 takes 3.5 seconds, giving the presenter 10 seconds to explain them. The remaining 52 parts accelerate exponentially over 14 seconds, for 24 seconds total uninterrupted playback, within the requested 25-second ceiling. This is demo pacing, not evidence that real inference or Fusion execution has that speed curve.
