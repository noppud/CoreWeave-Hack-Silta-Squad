...
- [Final W&B artifact](https://wandb.ai/silta/coreweave-hack-silta-squad/runs/cuto4ljg): **`silta-fusion-judge-evidence:v1`**, 13 completed campaign drawings, separate rehearsals, the final film and learning/evaluation evidence. All 2588 remote entries match local file digests. [Publication/readback receipt](../output/sponsors/fusion-artifact-receipt-v1.json). The older v0 remains an earlier partial snapshot.
