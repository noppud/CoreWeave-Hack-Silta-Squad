The current 11-slide pitch with recordings and learning examples is [the pitch app](pitch-app/SILTA%20Pitch%20Deck.dc.html). The 27-part curve is visibly labeled as illustrative.
