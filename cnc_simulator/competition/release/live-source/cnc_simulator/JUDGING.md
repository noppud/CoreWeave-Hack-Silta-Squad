...
| Sponsor usage | Separate Fusion project has retained Weave links in `../docs/learning-results.md` and `../docs/demo-evaluation.md` | This live simulator is not yet verified in Weave; do not present Fusion traces as simulator traces |
