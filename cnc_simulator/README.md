The current measured two-loop presentation is documented in [DEMO.md](DEMO.md).

The five-part indexed 3+2 experiment, videos and saved-memory loop are documented in [INDEXED.md](INDEXED.md).
