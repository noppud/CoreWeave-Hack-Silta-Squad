...
def main():
    ...
    target.write_text(
        (ROOT / "scripts/pitch_template.html")
        .read_text(encoding="utf-8")
        .replace("__TEAM_IMAGE__", "data:image/jpeg;base64," + photo),
        encoding="utf-8",
    )
...
padding:12px;text-align:left;vertical-align:top}code{font-size:.85em}pre{overflow:auto}
    ...
    (ROOT / "demo/guide.html").write_text(guide.replace("CONTENT", notes), encoding="utf-8")
    print(target)
